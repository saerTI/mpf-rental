...
export default function Footer() {
  const { brand } = useSite();
  const { contact, social, logo } = brand;
        ...
        <div className="py-12 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              <li>
                <a href={`tel:${contact.phoneE164}`} className="text-gray-400 hover:text-white transition flex items-center gap-2">
              ...
              <li>
                <a href={`mailto:${contact.email}`} className="text-gray-400 hover:text-white transition flex items-center gap-2">
                  <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <li className="text-gray-400 flex items-center gap-2">
                ...
                {contact.address.country === 'CL' ? 'Chile' : contact.address.country}
              </li>
            </ul>
          </div>
        </div>
            ...
            <div className="flex flex-wrap items-center gap-x-4 gap-y-2 text-sm">
              {contact.openingHours.map((h, i) => (
                <div key={i} className="flex items-center gap-2">
                  {i > 0 && <div className="hidden md:block w-px h-4 bg-gray-700" />}
                  <span className="text-gray-400">{formatDays(h.days)}:</span>
